...
public interface ITmsHubClient
{
    ...
    // Broadcast newly added enrollment to all connected clients
    Task ReceiveEnrollmentAdded(EnrollmentResponseDto enrollment);

    // Broadcast enrollment status changes to all connected clients
